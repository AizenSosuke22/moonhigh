    ...
    <div dir="rtl" class="bg-black w-full min-h-screen bg-cover bg-[url('https://images.unsplash.com/photo-1634449571010-02389ed0f9b0?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] flex lg:flex-row sm:flex-col sm:py-[100px] lg:py-8 gap-y-10">
        ...
        <div class="flex-1 lg:flex lg:justify-center lg:items-center">
            <div class="sm:mx-auto sm:w-[90%] md:w-[80%] lg:w-[80%] h-fit px-8 py-10 rounded-lg bg-[white]">
                ...
                <form method="POST" action="{{ route('login') }}" class="mt-6 font-[400] text-[14px]">
                    @csrf
                    ...
                    <div class="flex-1 mt-6">
                        <a href="{{ route('password.request') }}" class="font-[600] underline text-[#a288a6]">هل نسيت كلمة السر ؟</a>
                    </div>
                    ...
                    <a href="{{ url('/register') }}" class="w-full text-center block px-6 py-3 mt-2 text-sm font-medium tracking-wide text-[#a288a6] capitalize transition-colors duration-300 transform border-[#a288a6] border-[1px] rounded-md focus:outline-none focus:ring focus:ring-[#00000082] focus:ring-opacity-50">
                    إنشاء حساب
                    </a>
                </form>
            </div>
